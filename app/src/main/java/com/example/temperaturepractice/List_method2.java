...
public class List_method2 extends AppCompatActivity implements Runnable {
    String TAG="Info";
    Handler handler;
    String[] list1={};
    @Override
        ...
        handler=new Handler(){
            ...
            public void handleMessage(@NonNull Message msg) {
                if(msg.what==5){
                    ...
                    ListAdapter adapter=new ArrayAdapter<String>(List_method2.this,android.R.layout.simple_list_item_1,list1);
